...
const SERVICE_CLUSTERS = [
  {
    ...
    displayDesc: "Revenue-generating AI that captures, qualifies, and books appointments around the clock — no manual dialing, no missed calls, no added headcount. Our automation clients average 3x booked meetings within 60 days of going live.",
    icon: Bot,
  ...
  },
  {
    ...
    displayDesc: "Long-term organic dominance built on technical authority, topical content depth, and link acquisition — not tricks that expire with the next algorithm update. 90%+ of our SEO clients reach page one for their primary keywords within 6 months.",
    icon: Search,
  ...
  },
  {
    ...
    displayDesc: "Intent-driven Google campaigns and audience-targeted Meta ads managed as integrated revenue systems — not isolated experiments. Clients achieve 4–6x ROAS on Google and 3.2x on Meta within the first 60–90 days.",
    icon: Target,
  ...
  },
  {
    ...
    displayDesc: "Conversion-optimized websites, high-performance landing pages, and brand systems designed specifically for businesses that need their digital presence to generate revenue, not just traffic. Every project includes CRO principles from wireframe to launch.",
    icon: Monitor,
