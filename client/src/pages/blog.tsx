          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {BLOG_POSTS.map((post, i) => (
              <GlassCard key={post.id} delay={i * 0.08} className="flex flex-col">
                <div className="h-40 rounded-md bg-gradient-to-br from-blue-100 to-purple-100 dark:from-blue-500/10 dark:to-purple-500/10 mb-4 flex items-center justify-center">
                ...
                <div className="flex items-center justify-between gap-2 mt-auto pt-4 border-t border-border/50">
                  ...
                  <span className="text-sm font-medium text-blue-600 dark:text-blue-400 flex items-center gap-1 cursor-pointer">
