...
const INDUSTRY_VERTICAL_PAGES: Record<string, {
  ...
  "automated-review-requests": { title: "Automated Review Requests | AI-Powered Review Generation", desc: "Automated review request system that sends personalized SMS and email requests at the perfect moment — generating 3x more reviews with zero manual effort.", faqs: [{ q: "What systems does it connect to for completion triggers?", a: "We integrate with major CRMs (HubSpot, Salesforce, GoHighLevel), booking platforms (Calendly, Acuity), job management software (ServiceTitan, Jobber, Housecall Pro), and most POS systems — or via Zapier/webhook for custom setups." }, { q: "Can I customize the review request messages?", a: "Yes. We build custom templates for each service type you offer, with AI personalization adding service-specific details automatically. You approve all templates before launch." }, { q: "What happens if a customer leaves a bad review?", a: "The system monitors for negative reviews in real-time. When one appears, you're notified immediately with an AI-generated response suggestion. Responding quickly and professionally significantly reduces the impact on your overall rating." }] },
  ...
  "review-request-software": { title: "Review Request Software | AI-Automated Review Generation", desc: "Review request software that sends personalized SMS and email requests automatically — generating 3x more reviews than manual requests. Setup in 24 hours. Free demo.", faqs: [{ q: "What response rates should I expect?", a: "SMS review requests typically achieve 40-67% response rates when personalized and timed correctly. Email-only requests average 8-15%. Our combined SMS + email sequences achieve 55-70% average response rates — 3-5x industry average for generic software." }, { q: "How is this different from just texting customers manually?", a: "Manual texting is inconsistent — you forget, you send at wrong times, you send generic messages. Our software ensures 100% of customers receive personalized, perfectly-timed requests automatically, every single time." }, { q: "Can I use my existing customer list to generate reviews?", a: "Yes. We can run a one-time reactivation campaign to your existing customer list to generate reviews from past customers — in addition to ongoing automation for new customers." }] },
  "local-business-reputation-management": { title: "Local Business Reputation Management | AI Review System", desc: "AI reputation management for local businesses — generate more reviews, monitor all platforms, and dominate local search. 500+ local business clients. Free reputation audit.", faqs: [{ q: "How important are Google reviews for local search rankings?", a: "Extremely important. Google uses review count, rating, review velocity, and response rate as local search ranking factors. Businesses that consistently generate reviews hold significant ranking advantages over those that don't." }, { q: "Which review platforms matter most for local businesses?", a: "Google reviews have the highest impact on local search rankings. Beyond Google: Yelp matters for restaurants and some home services, Facebook for trust signals, and industry-specific platforms (Healthgrades for healthcare, HomeAdvisor for contractors, Avvo for legal)." }, { q: "How do I respond to negative reviews?", a: "The key is speed and professionalism. AI-generated response suggestions provide a starting point within 60 seconds of a negative review appearing. Professional, empathetic responses frequently prompt customers to update their rating." }] },
  "business-texting-software": { title: "Business Texting Software | AI Two-Way SMS for Business", desc: "AI-powered business texting software that handles two-way SMS conversations, automates follow-ups, and books appointments via text. No annual contract.", faqs: [{ q: "Can the AI really handle full SMS conversations?", a: "Yes. Our AI uses advanced natural language processing to handle multi-turn SMS conversations — answering questions, addressing objections, and booking appointments through natural text exchanges that customers rarely distinguish from a human." }, { q: "Is business texting TCPA compliant?", a: "Yes. Our system includes built-in TCPA compliance features — opt-in capture, opt-out management, consent timestamp recording, and compliant messaging flows." }, { q: "What CRMs does the SMS system integrate with?", a: "HubSpot, Salesforce, GoHighLevel, Pipedrive, Zoho, Close.com, and most other major CRM platforms with bi-directional sync." }] },
...
const STATIC_PAGES: Record<string, SEOMeta> = {
  "/": { title: "Infinite Rankers | AI Revenue Systems Agency USA", description: "Infinite Rankers builds and deploys AI Revenue Systems — lead capture, appointment agents, CRM automation, customer support AI, and custom SaaS tools for USA businesses. Google Partner. Free strategy call.", canonical: `${BASE}/` },
  ...
  "/services": { title: "7 AI Revenue Systems | Full-Stack Automation Services", description: "Explore Infinite Rankers' 7 AI Revenue Systems: lead capture, appointment agents, CRM automation, customer support AI, reviews & retention, custom SaaS tools, and revenue consulting.", canonical: `${BASE}/services` },
