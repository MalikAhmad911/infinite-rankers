...
const LANDING_PAGES: Record<string, { title: string; desc: string; faqs?: { q: string; a: string }[] }> = {
  "ai-automation-new-york": { title: "AI Automation Services in New York | Infinite Rankers", desc: "Transform your New York business with AI automation systems that generate leads, book appointments, and grow revenue 24/7. Trusted by 45+ NYC businesses." },
  "ai-automation-los-angeles": { title: "AI Automation Services in Los Angeles | Infinite Rankers", desc: "Grow your Los Angeles business with AI automation that generates leads, books appointments, and increases revenue 24/7. Serving 35+ LA businesses." },
  "ai-automation-chicago": { title: "AI Automation Services in Chicago | Infinite Rankers", desc: "Chicago businesses trust Infinite Rankers for AI automation that drives leads, books appointments, and grows revenue. Serving 30+ Chicagoland businesses." },
