...
const LANDING_PAGES: Record<string, { title: string; desc: string; faqs?: { q: string; a: string }[] }> = {
  ...
  "chatgpt-ads": { title: "ChatGPT Ads & AI-Powered Ad Campaigns | Infinite Rankers", desc: "AI-crafted ad campaigns using ChatGPT-powered copy and targeting. Clients cut cost per lead by 40% with smarter messaging. Free AI ad strategy session.", faqs: [{ q: "How does AI improve ad performance?", a: "AI generates and tests hundreds of ad copy variations simultaneously, identifies winning patterns faster than manual testing, and optimizes bids and audiences in real-time." }, { q: "Which platforms do ChatGPT-enhanced ads run on?", a: "Google Ads, Meta Ads (Facebook & Instagram), LinkedIn Ads, and YouTube Ads — all optimized with AI-generated copy and targeting intelligence." }, { q: "Can AI ads replace my existing ad campaigns?", a: "We layer AI enhancement onto your existing campaigns or build new campaigns from scratch — whichever approach delivers faster results for your business." }, { q: "What cost savings can I expect?", a: "Most clients see 30–50% reduction in cost per lead within the first 60 days through smarter copy testing and audience optimization." }] },
  "google-ads-for-service-businesses": { title: "Google Ads for Service Businesses | 4-6x ROAS | Infinite Rankers", desc: "Google Ads built for service businesses — plumbers, dentists, lawyers, HVAC, med spas & more. Avg 4-6x ROAS in 90 days. Free Google Ads audit today.", faqs: [{ q: "Why do service businesses need specialized Google Ads management?", a: "Service businesses compete for high-intent local keywords where targeting, bidding strategy, and call tracking must be optimized for phone calls and appointment bookings — not just clicks." }, { q: "What service industries do you specialize in?", a: "Home services, healthcare, legal, dental, med spas, real estate, insurance, financial services, and professional services across the USA." }, { q: "How do you track Google Ads ROI for service businesses?", a: "We track phone calls, form submissions, booked appointments, and revenue attributed to ads — giving you a clear picture of actual return on ad spend." }, { q: "What is the minimum budget for Google Ads?", a: "We recommend a minimum of $2,000/month in ad spend for meaningful results, with budgets scaling as ROAS is proven." }] },
  "meta-ads-for-service-businesses": { title: "Meta Ads for Service Businesses | 3.2x ROAS | Infinite Rankers", desc: "Facebook & Instagram ads for service businesses — lead generation, retargeting & appointment booking campaigns. Avg 3.2x ROAS in 60 days. Free Meta audit.", faqs: [{ q: "Do Meta Ads work for local service businesses?", a: "Yes. Facebook and Instagram targeting allows hyper-local reach by zip code, radius, and demographics — ideal for home services, healthcare, legal, and personal services." }, { q: "What type of Meta Ads work best for services?", a: "Lead generation ads with instant forms, retargeting campaigns for website visitors, and video ads showcasing results and testimonials drive the highest ROI for service businesses." }, { q: "How do you generate leads without a landing page?", a: "Meta's native lead forms allow prospects to submit their contact information without leaving Facebook or Instagram — dramatically reducing friction and increasing conversion." }, { q: "How quickly can a Meta Ads campaign launch?", a: "Campaigns are typically live within 5–7 business days including audience setup, creative production, and campaign configuration." }] },
